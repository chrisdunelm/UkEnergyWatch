...
2014:03:03:21:31:39:GMT: subject=BMRA.BM.T_BLLA-1.FPN, message={SD=2014:03:03:00:00:00:GMT,SP=46,NP=4,TS=2014:03:03:22:30:00:GMT,VP=4.0,TS=2014:03:03:22:45:00:GMT,VP=4.0,TS=2014:03:03:22:45:00:GMT,VP=5.0,TS=2014:03:03:23:00:00:GMT,VP=5.0}
    ...
    Downloads.list.id0 shouldBe List(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 3, 21, 30), t(2014, 3, 3, 22, 00)))
    BmUnitFpns.sortBy(_.id).list.id0 shouldBe List(
      BmUnitFpn(0, "T_BARKB2", t(2014, 3, 3, 22, 30), 0, t(2014, 3, 3, 23, 0), 0),
      BmUnitFpn(0, "E_BETHW-1", t(2014, 3, 3, 22, 30), 2, t(2014, 3, 3, 22, 31), 3),
      BmUnitFpn(0, "E_BETHW-1", t(2014, 3, 3, 22, 31), 3, t(2014, 3, 3, 23, 0), 3),
      BmUnitFpn(0, "T_BLLA-1", t(2014, 3, 3, 22, 30), 4, t(2014, 3, 3, 22, 45), 4),
      BmUnitFpn(0, "T_BLLA-1", t(2014, 3, 3, 22, 45), 5, t(2014, 3, 3, 23, 0), 5)
    )
  }
...
2014:03:03:21:31:39:GMT: subject=BMRA.BM.T_BARKB2.FPN, message={SD=2014:03:03:00:00:00:GMT,SP=46,NP=2,TS=2014:03:03:22:30:00:GMT,VP=0.0,TS=2014:03:03:23:00:00:GMT,VP=0.0}
    ...
    Downloads.mergeInsert(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 3, 21, 30), t(2014, 3, 3, 22, 0)))
    ...
    Downloads.list.id0 shouldBe List(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 3, 21, 30), t(2014, 3, 3, 22, 30)))
    BmUnitFpns.list.id0 shouldBe List(BmUnitFpn(0, "T_BARKB2", t(2014, 3, 3, 22, 30), 0, t(2014, 3, 3, 23, 0), 0))
  }
...
2014:03:03:21:31:39:GMT: subject=BMRA.BM.T_BARKB2.FPN, message={SD=2014:03:03:00:00:00:GMT,SP=46,NP=2,TS=2014:03:03:22:30:00:GMT,VP=0.0,TS=2014:03:03:23:00:00:GMT,VP=0.0}
    ...
    Downloads.mergeInsert(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 1, 21, 30), t(2014, 3, 1, 22, 0)))
    ...
    Downloads.list.id0 shouldBe List(
      Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 1, 21, 30), t(2014, 3, 1, 22, 0)),
      Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 3, 21, 0), t(2014, 3, 3, 21, 30))
    )
    BmUnitFpns.list.id0 shouldBe List(BmUnitFpn(0, "T_BARKB2", t(2014, 3, 3, 22, 30), 0, t(2014, 3, 3, 23, 0), 0))
  }
  ...
  it should "do nothing when there is no more data to load yet" in prepare { implicit session =>
    ...
    Downloads.list.id0 shouldBe List(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 1, 21, 30), t(2014, 3, 1, 22, 0)))
...
2014:03:03:22:01:39:GMT: subject=BMRA.BM.T_BARKB2.FPN, message={SD=2014:03:03:00:00:00:GMT,SP=46,NP=2,TS=2014:03:03:22:30:00:GMT,VP=0.0,TS=2014:03:03:23:00:00:GMT,VP=0.0}
    ...
    Downloads.list.id0 shouldBe List(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 3, 21, 30), t(2014, 3, 3, 22, 0)))
    BmUnitFpns.list.id0 shouldBe List()
  }
...
2014:03:03:21:31:39:GMT: subject=BMRA.BM.T_BARKB2.FPN, message={SD=2014:03:03:00:00:00:GMT,SP=46,NP=2,TS=2014:03:03:22:30:00:GMT,VP=0.0,TS=2014:03:03:23:00:00:GMT,VP=0.0}
    ...
    Downloads.mergeInsert(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 3, 21, 30), t(2014, 3, 5, 0, 0)))
    ...
    Downloads.list.id0 shouldBe List(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 3, 0, 0), t(2014, 3, 5, 0, 0)))
    BmUnitFpns.list.id0 shouldBe List(BmUnitFpn(0, "T_BARKB1", t(2014, 3, 3, 21, 30), 1, t(2014, 3, 3, 22, 0), 1))
  }
...
2014:03:02:21:21:39:GMT: subject=BMRA.BM.T_BARKB1.FPN, message={SD=2014:03:02:00:00:00:GMT,SP=46,NP=2,TS=2014:03:02:21:30:00:GMT,VP=1.0,TS=2014:03:02:22:00:00:GMT,VP=1.0}
    ...
    Downloads.mergeInsert(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 3, 0, 0), t(2014, 3, 5, 0, 0)))
    ...
    Downloads.list.id0 shouldBe List(Download(0, Downloads.TYPE_BMUFPN, t(2014, 3, 2, 0, 0), t(2014, 3, 5, 0, 0)))
    BmUnitFpns.list.id0 shouldBe List(BmUnitFpn(0, "T_BARKB1", t(2014, 3, 2, 21, 30), 1, t(2014, 3, 2, 22, 0), 1))
  }
